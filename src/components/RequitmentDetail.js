...
function RequitmentDetail(){
    ...
    return(
        <div className="screen_requitment_detail">
            ...
            <div style={{ margin: "0px 0px", height: "20%"}}><Top text ='채용상세'></Top></div>
            <section className="body_1_detail"> 
                <div className="body_1_title_detail"> 
                    <span className="title_item1_detail">모집중</span>
                    <span className="title_item2_detail">진주시 요양원 조리원 모집</span>
                </div>
            ...
            <section className="body_2_detail"> 
                <span className="detail_text"> 5~7세 아이들에게 동화책을 읽어주는 구연 강사 채용합니다.
                    아이들을 사랑하는 마음만 있으면 충분히 하실 수 있습니다.
                    <br></br>
                    - 우대사항 : 교육 관련 직종 근무
                </span>
            </section>
            <section className='footer_detail'> 
                ...
                <button className={`btn_apply ${btn_apply_state === 0 ? '' : 'no_call'}`}>지원하기</button>                    
             </section>
