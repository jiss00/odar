        ...
        <div className="screen_requitment_detail">
            ...
            <StyledSection type="1">
                <StyledDiv type = "head">
                    ...
                    <StyledSpan type = "title"> 진주시 요양원 조리원 모집</StyledSpan>
                </StyledDiv>
                <StyledHr></StyledHr>
                <div>
                    <ImgMoney></ImgMoney>
                    <StyledSpan type = "write" height="14px" top="72px" left="116px">월급</StyledSpan>
                    ...
                    <StyledSpan type = "write" height="14px" top="136px" left="107px">근무 시간</StyledSpan>
