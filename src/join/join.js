    ...
    <div className='main'>
      ...
      <div className='sub'>
        ...
        <div className='phone_number'>
          ...
          <Auth phone={phone} usrName={usrName} year={year} month={month} day={day} func={onclick} text='인증' />
        </div>
        <div className='phone_number'>
          ...
          <Auth phone={phone} usrName={usrName} year={year} month={month} day={day} func={confirm} text='완료' />
        </div>
        {/*
